...
namespace TradingExpanded.Components
{
    ...
    /// <summary>
    /// Ulak partisinin davranışını kontrol eden bileşen
    /// Banner King modundan esinlenerek daha güçlü hale getirilmiş
    /// </summary>
    public class CourierPartyComponent : TECompanent
    {
        public CourierPartyComponent(Settlement target, Settlement origin, string name, bool slaveCaravan,
            ...
            string name, PopType popType, bool trading = false)
        {
            return MobileParty.CreateParty(id + origin + target.Name,
                new CourierPartyComponent(target, origin, name, slaveCaravan, popType, trading),
